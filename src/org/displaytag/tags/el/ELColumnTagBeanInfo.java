...
/**
 * Changed this class to make it work with latest libraries.
...
public class ELColumnTagBeanInfo extends SimpleBeanInfo
{
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        {
            throw new RuntimeException("You got an introspection exception - " 
            	+ "maybe defining a property that is not defined in the bean?: "
                + ex.getMessage(), ex);
        }
