...
/**
 * Changed to make this work with Struts 2.3.28.1
...
public class Column
{
    ...
    public Object getValue(boolean decorated) throws ObjectLookupException, DecoratorException
    {
        ...
        else if (this.header.getBeanPropertyName() != null)
        {
            ...
            //Credit for this code snippet: Stuart Williamson (Ecebs Ltd).Ref: DISPL-223
            if (object != null && object instanceof String) {
                MediaTypeEnum mediaType = row.getParentTable().getMedia();
                if (mediaType == MediaTypeEnum.HTML || mediaType == MediaTypeEnum.XML) {
                    object = StringEscapeUtils.escapeHtml4((String) object);
                }
            }
            //End of code snippet
